(() => {
  ...
  controladorClientes.$inject = ['$http', 'servicioUsuarios', 'imageUpload', 'Upload', 'NgMap'];

  function controladorClientes($http, servicioUsuarios,  imageUpload, Upload, NgMap){
    let vm = this;
    ...
    vm.registrarCliente = (pNuevoCliente, urlImagen) => {
      ...
      // pnuevoCliente.agregarTarjeta(nuevaTarjeta);
