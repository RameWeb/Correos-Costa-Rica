...
module.exports.registrar = function(req, res) {
  ...
  newsucursales.save(function(error) {
    if (error) {
      res.json({ success: false, msg: 'Ha ocurrido un error en el registro del sucursales' + error });
    } else {
      res.json({ success: true, msg: 'Se registró el sucursales correctamente' });
    }
  })
};
/**
...
module.exports.actualizar = function(req, res) {
  UserModel.findByIdAndUpdate(req.body.idSucursal, { $set: req.body }, function(err, user) {
    if (err) {
